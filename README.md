...
Для VENV работосподобны такие команды:
...
Без активации VENV любая команда доступна, только если она начинается с самого питона с указанием полного пути к нему *(или без полного пути, но с запуском питона "из текущего каталога"из)*:
