...
> 
>Если нужный вам пакет не конфликтует ни с одним пакетов в системном питоне, то он может буть установлен в него, и будет доступне всем остальным VENV по праву "навледования" если оно включено.
> 
