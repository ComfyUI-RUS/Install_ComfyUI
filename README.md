...
>Примечание:
> 
>Если у вас установлено более одного экземпляра питона (разные версии, портабельный, venv) и меется более одного файла "**python.exe**" в разных установках, то отдача команд питону сстояит в указании полного пути до конкретного экземпляра файла "**pyhton.exe**" + сама команда и ее аргументы.
> 
...
> 
>Следует помнить, что. при установке более одного питона, пути к любому из них НЕ ДОЛЖНЫ БЫТЬ В "**PATH**"!!!
> 
>Наличие путей в "**PATH**" может привести к перхвату управлени тем питоном, который в PATH внесен. а не тем, которому вы отдлаете команду!!! 
