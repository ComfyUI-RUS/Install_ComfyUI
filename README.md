...
> 
>Следует помнить, что. при установке более одного питона, пути к любому из них НЕ ДОЛЖНЫ БЫТЬ В "**PATH**"!!! Наличие путей в "**PATH**" может привести к перхвату управлени тем питоном, который внесен в PATH, а не тем, которому вы отдлаете команду!!!
