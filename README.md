...
Заходим на сайт <a href="https://github.com/comfyanonymous/ComfyUI">https://github.com/comfyanonymous/ComfyUI</a> и ищем там в корне дистрибутива файл "**requirements.txt**". Щелкнем по нему, и посмотрим, что в нем.
