...
Комфи при старте торча в VENV не обнаружит, навледование включено, он полезет в пакеты "родителя", найдет там торч, и запустит на нем.
