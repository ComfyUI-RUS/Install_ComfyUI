...
В случае совпадения устанавливаемых пакетов в усстановке их будет отказано, т.к. будут использоваться те, что уже имеются в питоне-родителе, а те пакеты, которых нет в системно питоне, будут установлены в VENV без вмешательства в пакеты системного питона.
